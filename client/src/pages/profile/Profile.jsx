...
export default function Profile() {
  ...
  const { isLoading: relationshipIsLoading, data: relationshipData } = useQuery(['relationship'], async () => {
    ...
    <div className='profile'>
      {isLoading ? 'loading...' :
        <><div className="images">
          <img src={data.coverPic ? "/upload/" + data.coverPic : Cover} alt="" className="cover" />
          <img src={data.profilePic ? "/upload/" + data.profilePic : Avater} alt="" className="profile" />
        </div><div className="profileContanier">
            <div className="uInfo">
              <div className="left">
              ...
              <div className="center">
                ...
                {relationshipIsLoading ? ("Loading") : userId === currentUser._id ? (<button onClick={() => setOpenUpdate(true)}>Update</button>) : <button onClick={handleFollow}>{relationshipData.includes(currentUser._id) ? "following" : 'follow'}</button>}
              </div>
              <div className="right">
                <img src={Email} alt="" />
